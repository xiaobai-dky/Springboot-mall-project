...
import com.xiaobai.store.mapper.OrderMapper;
...
import com.xiaobai.store.service.ex.InsertException;
import com.xiaobai.store.service.ex.OrderNotFoundException;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public List<Order> findOrdersByUid(Integer uid) {
        List<Order> res = orderMapper.findOrdersByUid(uid);
        return res;
    }

    @Override
    public List<OrderItem> findOrderItemsByOid(Integer oid) {
        List<OrderItem> res = orderMapper.findOrderItemsByOid(oid);
        return res;
    }
